...
def resnet10(input_channel=3, num_classes=10):
    return ResNet(BasicBlock, [1, 1, 1, 1], input_channel, num_classes)


def resnet18(input_channel=3, num_classes=10):
    return ResNet(BasicBlock, [2, 2, 2, 2], input_channel, num_classes)


def resnet34(input_channel=3, num_classes=10):
    return ResNet(BasicBlock, [3, 4, 6, 3], input_channel, num_classes)


def resnet50(input_channel=3, num_classes=10):
    return ResNet(Bottleneck, [3, 4, 6, 3], input_channel, num_classes)


def resnet101(input_channel=3, num_classes=10):
    return ResNet(Bottleneck, [3, 4, 23, 3], input_channel, num_classes)


def resnet152(input_channel=3, num_classes=10):
    return ResNet(Bottleneck, [3, 8, 36, 3], input_channel, num_classes)


def get_resnet(size=18, input_channel=3, num_classes=10):
    if size == 18:
        return ResNet(BasicBlock, [2, 2, 2, 2], input_channel, num_classes)
    elif size == 10:
        return ResNet(BasicBlock, [1, 1, 1, 1], input_channel, num_classes)
        ...
        raise ValueError("size does not exist.")
